...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  function applyAuth(data: { accessToken: string; refreshToken: string; user: User }) {
  ...
  return (
    <AuthContext.Provider value={{ user, loading, login, register, loginWithTokens, refreshUser, setUser, logout }}>
      {children}
