    ...
    <div className="center-screen">
      ...
      <form className="card" onSubmit={onSubmit} style={{ maxWidth: 380 }}>
        <div className="card__head">
          ...
          <p className="card__sub">Choose a strong password you don't use elsewhere.</p>
        </div>
        {!token && <div className="alert">This reset link is missing its token.</div>}
        ...
        {done ? (
          ...
          <>
            <div className="field">
              <label className="field__label" htmlFor="pw">New password</label>
              <PasswordInput id="pw" placeholder="••••••••" value={password}
